...
Der Core bewertet Ereignisse und Item-Kontext gegen diese Templates. Dadurch kann APRIL feststellen, ob ein Prozess dem erwarteten Ablauf folgt oder ob Abweichungen entstehen.
...
- SLA-Verletzungen
- Kontextabweichungen
- unvollstaendige oder widerspruechliche Item-Zustaende
...
- konkrete DMS-, ERP-, SaaS- oder Workflow-API-Clients
- connector-spezifische API-Aufrufe, Tokenprovider und Credential-Events
